...
const JSONNET_SAMPLES_DIRECTORY: &'static str = "crates/oracle-encoder/examples/jsonnet-examples";
const JSON_SAMPLES_DIRECTORY: &'static str = "crates/oracle-encoder/examples/";
