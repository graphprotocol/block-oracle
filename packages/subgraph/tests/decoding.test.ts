...
describe("U64", () => {
  ...
  test("Decoding InvalidFormat 0x0011", () => {
    // 18446744073709551615 -> [0, 255, 255, 255, 255, 255, 255, 255, 255] 0x00FFFFFFFFFFFFFFFF
  ...
  test("Decoding InvalidFormat 0x00", () => {
    // 18446744073709551615 -> [0, 255, 255, 255, 255, 255, 255, 255, 255] 0x00FFFFFFFFFFFFFFFF
  ...
  test("Decoding InvalidFormat 0x00FFFFFFFFFFFFFF (1 byte less than valid)", () => {
    // 18446744073709551615 -> [0, 255, 255, 255, 255, 255, 255, 255, 255] 0x00FFFFFFFFFFFFFFFF
